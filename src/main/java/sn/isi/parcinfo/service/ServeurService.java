...
public class ServeurService implements IServeurService{
    ...
    @Override
    public void remove(@NotNull Serveur serveur) {iServeurDao.delete(iServeurDao.findById(serveur.getId()).get());}

    @Override
    public Serveur get(int id) {return iServeurDao.findById(id).get();}
